  ...
  conf.json.toOption match {
    ...
    case Some(jsonFile) => {
      val answers = ujson.Obj(
        ...
        "R.1" -> ujson.Obj(
          "PredUser1Item1" -> ujson.Num(predictorSimilarity_k(data.union(personal),300)(1,1)) // Prediction for user 1 of item 1
        ),
        ...
        "R.2" -> best_i_item_for_user_u(data.union(personal),predictorSimilarity_k,300)(944,3).map(x => ujson.Arr(x._1, movieNames(x._1), x._2))
       )
