    ...
    conf.json.toOption match {
      ...
      case Some(jsonFile) => {
        val answers = ujson.Obj(
          ...
          "EK.1" -> ujson.Obj(
            "1.knn_u1v1" -> ujson.Num(similarity_k_exact(train,10,sc)(1,1)),
            "2.knn_u1v864" -> ujson.Num(similarity_k_exact(train,10,sc)(1,864)),
            "3.knn_u1v886" -> ujson.Num(similarity_k_exact(train,10,sc)(1,886)),
            "4.PredUser1Item1" -> ujson.Num(predict_k_exact(train,10,sc)(1,1)),
            "5.PredUser327Item2" -> ujson.Num(predict_k_exact(train,10,sc)(327,2)),
            "6.Mae" -> ujson.Num(mae_exact(train,test,10,sc))
          ),
          "EK.2" ->  ujson.Obj(
